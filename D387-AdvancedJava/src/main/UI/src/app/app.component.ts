...
export class AppComponent implements OnInit{
  ...
  currentCheckOutVal!:string;
    ...
    ngOnInit(){
      ...
      this.presentationTimes$ = this.httpClient.get(this.baseURL + '/presentationTimes/presentations', {responseType: 'text'})
    ...
    onSubmit({value,valid}:{value:Roomsearch,valid:boolean}){
      this.getAll().subscribe(
        ...
        rooms => {
                ...
                this.rooms.forEach(room => {room.priceEuro = room.price;
                                                    room.priceCanadian = room.price})
        }
      );
    }
