...
class PartTest {
    ...
    @Test
    void testIsInvInMinBound(){
        int minimum = 1;
        partIn.setMinimumInv(minimum);
        assertEquals(minimum, partIn.getMinimumInv());
        partOut.setMinimumInv(minimum);
        assertEquals(minimum, partOut.getMinimumInv());
    }

    @Test
    void testIsInvInMaxBound(){
        int maximum = 100;
        partIn.setMaximumInv(maximum);
        assertEquals(maximum, partIn.getMaximumInv());
        partOut.setMaximumInv(maximum);
        assertEquals(maximum, partOut.getMaximumInv());
    }
